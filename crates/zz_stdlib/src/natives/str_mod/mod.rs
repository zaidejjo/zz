...
pub(crate) fn str_length(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
    let s = expect_str(args, 0, "std.str.length")?;
    Ok(Value::Int(s.chars().count() as i64))
}

pub(crate) fn str_split(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
...
pub(crate) fn str_trim(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
...
pub(crate) fn str_replace(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
