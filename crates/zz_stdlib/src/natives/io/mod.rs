...
pub(crate) fn printz(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
...
pub(crate) fn println(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
    let v = args.first().cloned().ok_or_else(|| {
        EvalError::new(
...
pub(crate) fn read_line(_interp: &mut Interp, args: &mut Vec<Value>) -> Result<Value, EvalError> {
