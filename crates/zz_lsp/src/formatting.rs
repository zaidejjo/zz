//! Document formatting using the ZZ AST.
//!
//! Produces a full-document `TextEdit` that reformats the source
//! according to ZZ style conventions. The formatter is also usable
//! from CLI tools like `zz fmt`.
